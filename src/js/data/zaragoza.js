export const zaragoza = {
  ...
  pois: [
    { id: 'z01', name: 'Basilique del Pilar', description: 'L\'un des plus grands sanctuaires mariaux au monde. Chef-d\'œuvre baroque aux coupoles colorées.', lat: 41.6558, lng: -0.8790, category: 'monuments', emoji: '⛪', image: 'https://upload.wikimedia.org/wikipedia/commons/6/62/Zaragoza_-_Basilica_de_Nuestra_Se%C3%B1ora_del_Pilar_01.jpg' },
    { id: 'z02', name: 'Cathédrale de la Salvator', description: 'Cathédrale gothique-mudéjare, seule cathédrale de style mudéjare au monde.', lat: 41.6535, lng: -0.8765, category: 'monuments', emoji: '🏰', image: 'https://upload.wikimedia.org/wikipedia/commons/4/45/La_Seo-Zaragoza_-_P1410404.jpg' },
    { id: 'z03', name: 'Aljafería', description: 'Palais musulman du XIe siècle, joyau de l\'art hispano-mauresque et siège des Cortes d\'Aragon.', lat: 41.6577, lng: -0.8930, category: 'monuments', emoji: '🕌', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0c/Aljafer%C3%ADa_Palace.jpg' },
    { id: 'z04', name: 'Torres de la Magdalena', description: 'Ruines des anciennes tours défensives médiévales sur l\'Ebre.', lat: 41.6580, lng: -0.8720, category: 'architecture', emoji: '🏰', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Zaragoza_-_Bas%C3%ADlica_del_Pilar_y_r%C3%ADo_Ebro.jpg' },
    { id: 'z05', name: 'Mirador del Ebro', description: 'Point de vue exceptionnel sur le fleuve Ebre et la basilique.', lat: 41.6600, lng: -0.8850, category: 'viewpoints', emoji: '🔭', image: 'https://upload.wikimedia.org/wikipedia/commons/e/ef/Zaragoza_shel.JPG' },
    { id: 'z06', name: 'Parc de la Milla Digital', description: 'Parc urbain moderne le long de l\'Ebre avec art contemporain et espaces verts.', lat: 41.6630, lng: -0.8820, category: 'nature', emoji: '🌿', image: 'https://upload.wikimedia.org/wikipedia/commons/c/cf/Parque_Grande.jpg' },
    { id: 'z07', name: 'Galería del Color', description: 'Passage piéton coloré unique en Europe avec des œuvres d\'art contemporain.', lat: 41.6502, lng: -0.8820, category: 'streetart', emoji: '🎨', image: 'https://upload.wikimedia.org/wikipedia/commons/1/14/Flag_of_Zaragoza.svg' },
    { id: 'z08', name: 'Plaza del Torico', description: 'Petite place pittoresque avec la fontaine Torico, symbole de la ville.', lat: 41.6510, lng: -0.8805, category: 'culture', emoji: '⛲', image: 'https://upload.wikimedia.org/wikipedia/commons/a/a5/Plaza_del_Torico_%28Teruel%29.jpg' },
    { id: 'z09', name: 'Casa de los Picos', description: 'Palais gothique du XVe siècle avec sa façade couverte de pyramides de pierre.', lat: 41.6525, lng: -0.8790, category: 'architecture', emoji: '🏠', image: 'https://upload.wikimedia.org/wikipedia/commons/e/e1/Zaragoza_Mapa_Junta_Las_Fuentes.svg' },
    { id: 'z10', name: 'Puente de Piedra', description: 'Pont de pierre du XVIIIe siècle, point de vue idéal sur la basilique.', lat: 41.6545, lng: -0.8755, category: 'monuments', emoji: '🌉', image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Puente_de_Piedra%2C_sobre_el_r%C3%ADo_Ebro%2C_en_Zaragoza%2C_Espa%C3%B1a.jpg' },
    { id: 'z11', name: 'Museo del Foro de Caesaraugusta', description: 'Ruines du forum romain de la Caesaraugusta antique.', lat: 41.6500, lng: -0.8860, category: 'culture', emoji: '🏛️', image: 'https://upload.wikimedia.org/wikipedia/commons/2/28/Hw-augustus.jpg' },
    { id: 'z12', name: 'Street Art El Gancho', description: 'Le quartier El Gancho regorge de fresques murales colorées et engagées.', lat: 41.6480, lng: -0.8860, category: 'streetart', emoji: '🎨', image: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/San_Pablo_Zaragoza_06.JPG' },
    { id: 'z13', name: 'Basílica del Pilar - Coupoles', description: 'Les 10 coupoles peintes par Goya de la basilique, vues depuis l\'intérieur.', lat: 41.6556, lng: -0.8788, category: 'monuments', emoji: '⛪', image: 'https://upload.wikimedia.org/wikipedia/commons/6/62/Zaragoza_-_Basilica_de_Nuestra_Se%C3%B1ora_del_Pilar_01.jpg' },
    { id: 'z14', name: 'Promenade de l\'Ebre', description: 'Promenade le long du fleuve Ebre entre les ponts historiques.', lat: 41.6550, lng: -0.8820, category: 'nature', emoji: '🌊', image: 'https://upload.wikimedia.org/wikipedia/commons/e/ef/Zaragoza_shel.JPG' },
    { id: 'z15', name: 'Mercado Central', description: 'Marché central art déco, temple de la gastronomie aragonaise.', lat: 41.6498, lng: -0.8880, category: 'gastronomy', emoji: '🏪', image: 'https://upload.wikimedia.org/wikipedia/commons/5/55/Mercado_Central-Zaragoza_-_PC281634.jpg' },
    { id: 'z16', name: 'Jardins de l\'Aljafería', description: 'Jardins du palais musulman avec fontaines et orangers.', lat: 41.6580, lng: -0.8935, category: 'nature', emoji: '🌺', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0c/Aljafer%C3%ADa_Palace.jpg' },
    { id: 'z17', name: 'Barrio de Tubo', description: 'Le plus animé des quartiers historiques, labyrinthe de rues et de bars.', lat: 41.6520, lng: -0.8830, category: 'gastronomy', emoji: '🍷', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Zaragoza_-_Bas%C3%ADlica_del_Pilar_y_r%C3%ADo_Ebro.jpg' },
    { id: 'z18', name: 'Teatro de la Zarzuela', description: 'Théâtre néo-baroque dédié à la zarzuela, spectacle lyrique espagnol.', lat: 41.6510, lng: -0.8870, category: 'architecture', emoji: '🎭', image: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Zaragoza_-_Bas%C3%ADlica_del_Pilar_y_r%C3%ADo_Ebro.jpg' },
    { id: 'z19', name: 'Jardines de Parque Grande', description: 'Le plus grand parc de Saragosse avec son palais et ses fontaines.', lat: 41.6420, lng: -0.8930, category: 'nature', emoji: '🌿', image: 'https://upload.wikimedia.org/wikipedia/commons/c/cf/Parque_Grande.jpg' },
    { id: 'z20', name: 'Street Art Las Fuentes', description: 'Le quartier Las Fuentes est une galerie à ciel ouvert de street art militant.', lat: 41.6400, lng: -0.8780, category: 'streetart', emoji: '🎨', image: 'https://upload.wikimedia.org/wikipedia/commons/e/e1/Zaragoza_Mapa_Junta_Las_Fuentes.svg' }
  ],
  routes: [
    {
      id: 'zr01',
