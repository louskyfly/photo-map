export const bilbao = {
  ...
  pois: [
    ...
    { id: 'b26', name: 'Pasarela de Euskalduna', description: 'Passerelle piéton secrète sur la Nervion, offrant une vue unique et inattendue sur le Guggenheim et le palais des Arts.', lat: 43.2660, lng: -2.9440, category: 'secrets', emoji: '🔮', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Puente_de_Vizcaya_desde_el_pasarela_de_Euskalduna.jpg/500px-Puente_de_Vizcaya_desde_el_pasarela_de_Euskalduna.jpg' },
    { id: 'b27', name: 'Jardín Botánico de Sarriko', description: 'Jardin botánique méconnu de l\'Université du Pays Basque, avec plus de 2000 espèces et une serre tropicale cachée.', lat: 43.2870, lng: -2.9510, category: 'secrets', emoji: '🔮', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Jard%C3%ADn_Bot%C3%A1nico_de_Sarriko.jpg/500px-Jard%C3%ADn_Bot%C3%A1nico_de_Sarriko.jpg' },
    { id: 'b28', name: 'Sótano del Casco Viejo', description: 'Caves voûtées médiévales sous les Siete Calles, accessibles depuis un bar à pintxos. Voutes du XIIIe siècle.', lat: 43.2618, lng: -2.9262, category: 'secrets', emoji: '🔮', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Casco_viejo.jpg/500px-Casco_viejo.jpg' }
  ],
  routes: [
    {
      id: 'br01',
