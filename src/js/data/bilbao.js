export const bilbao = {
  ...
  pois: [
    { id: 'b01', name: 'Guggenheim Bilbao', description: 'Musée d\'art contemporain conçu par Frank Gehry, emblème de la ville avec son architecture titane spectaculaire.', lat: 43.2677, lng: -2.9340, category: 'monuments', emoji: '🏛️', image: 'https://upload.wikimedia.org/wikipedia/commons/c/c7/Museo_Guggenheim%2C_Bilbao_%2831273245344%29.jpg' },
    { id: 'b02', name: 'Cathédrale de Santiago', description: 'Cathédrale gothique du XIIIe siècle, chef-d\'œuvre architectural au cœur de la vieille ville.', lat: 43.2630, lng: -2.9276, category: 'monuments', emoji: '⛪', image: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Bilbao_-_Catedral_de_Santiago_51.JPG' },
    { id: 'b03', name: 'Palais d\'Arts Reina Sofía', description: 'Complexe culturel monumental de Calatrava, hébergeant opéra et spectacles.', lat: 43.2685, lng: -2.9938, category: 'architecture', emoji: '🎭', image: 'https://upload.wikimedia.org/wikipedia/commons/8/8b/Ciutat_de_les_Arts_i_les_Ci%C3%A8ncies%2C_Val%C3%A8ncia%2C_Valencia%2C_Spain_-_panoramio_%2819%29.jpg' },
    { id: 'b04', name: 'Pont Zubizuri', description: 'Pont suspendu en verre de Calatrava, joyau architectural sur la Nervion.', lat: 43.2628, lng: -2.9304, category: 'architecture', emoji: '🌉', image: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Nervion.jpg' },
    { id: 'b05', name: 'Mirador de Artxanda', description: 'Point de vue panoramique sur toute la ville depuis la montagne.', lat: 43.2850, lng: -2.9200, category: 'viewpoints', emoji: '🔭', image: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Funicular_d%27Artxanda_des_del_pont_de_l%27Arenal_P1270339.jpg' },
    { id: 'b06', name: 'Parc d\'Etxebarria', description: 'Vaste parc verdoyant sur l\'ancien site industriel d\'Altos Hornos.', lat: 43.2670, lng: -2.9150, category: 'nature', emoji: '🌿', image: 'https://upload.wikimedia.org/wikipedia/commons/5/53/Bilbao_%2834176482331%29.jpg' },
    { id: 'b07', name: 'Jardins de Albia', description: 'Jardins élégants du XIXe siècle, havre de paix urbain.', lat: 43.2588, lng: -2.9320, category: 'nature', emoji: '🌺', image: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/Bilbao_-_Jardines_de_Albia_03.jpg' },
    { id: 'b08', name: 'Casco Viejo (Vieille Ville)', description: 'Le quartier historique Siete Calles avec ses rues médiévales et ses pintxos bars.', lat: 43.2616, lng: -2.9260, category: 'culture', emoji: '🏘️', image: 'https://upload.wikimedia.org/wikipedia/commons/1/1f/Casco_viejo.jpg' },
    { id: 'b09', name: 'Mercado de la Ribera', description: 'Plus grand marché couvert d\'Europe, pittoresque sur les rives de la Nervion.', lat: 43.2584, lng: -2.9288, category: 'gastronomy', emoji: '🏪', image: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Bilbao_-_Ribera.jpg' },
    { id: 'b10', name: 'Azkuna Zentroa', description: 'Centre culturel réhabilité par Philippe Starck, ancien marché aux abattoirs.', lat: 43.2612, lng: -2.9392, category: 'culture', emoji: '🎪', image: 'https://upload.wikimedia.org/wikipedia/commons/c/c0/Bilbao_Alhondiga-tomasfano-01.jpg' },
    { id: 'b11', name: 'Funiculaire d\'Artxanda', description: 'Funiculaire offrant une ascent rapide vers le mirador panoramique.', lat: 43.2706, lng: -2.9285, category: 'unusual', emoji: '🚡', image: 'https://upload.wikimedia.org/wikipedia/commons/e/e9/Funicular_de_Artxanda_1.jpg' },
    { id: 'b12', name: 'Street Art Ensanche', description: 'Quartier Ensanche richement décoré de fresques murales contemporaines.', lat: 43.2618, lng: -2.9330, category: 'streetart', emoji: '🎨', image: 'https://upload.wikimedia.org/wikipedia/commons/4/49/Collage_de_Bilbao%2C_Pa%C3%ADs_Vasco%2C_Espa%C3%B1a.png' },
    { id: 'b13', name: 'Église de San Nicolás', description: 'Église baroque du XVIIIe surnommée "Cathédrale des pintxos".', lat: 43.2632, lng: -2.9268, category: 'monuments', emoji: '⛪', image: 'https://upload.wikimedia.org/wikipedia/commons/2/25/Bilbao_-_San_Nicolas_21.jpg' },
    { id: 'b14', name: 'Promenade de la Nervion', description: 'Promenade le long de la rivière Nervion entre le Guggenheim et la Cathédrale.', lat: 43.2620, lng: -2.9310, category: 'nature', emoji: '🌊', image: 'https://upload.wikimedia.org/wikipedia/commons/2/21/Zubia_jun.jpg' },
    { id: 'b15', name: 'Circuit des bars à pintxos', description: 'Circuit des meilleurs bars à pintxos du Casco Viejo.', lat: 43.2614, lng: -2.9255, category: 'gastronomy', emoji: '🍢', image: 'https://upload.wikimedia.org/wikipedia/commons/5/56/Pinchos_bermeo_2.JPG' },
    { id: 'b16', name: 'Teatro Arriaga', description: 'Théâtre néo-baroque inspiré de l\'Opéra Garnier, joyau architectural.', lat: 43.2598, lng: -2.9272, category: 'architecture', emoji: '🎭', image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Casco_viejo_de_Bilbao_%281%29.jpg' },
    { id: 'b17', name: 'Abandoibarra', description: 'Zone de régénération urbaine le long de la rivière avec sculptures contemporaines.', lat: 43.2650, lng: -2.9310, category: 'streetart', emoji: '🗿', image: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/Abandoibarra4.jpg' },
    { id: 'b18', name: 'Doña Casilda Park', description: 'Principal parc urbain avec étang, paons et musée des Beaux-Arts.', lat: 43.2712, lng: -2.9430, category: 'nature', emoji: '🦚', image: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Bilbao_-_Parque_de_Do%C3%B1a_Casilda_Iturr%C3%ADzar_17.jpg' },
    { id: 'b19', name: 'Basílica de Begoña', description: 'Basílique gothique-Renaissance, patronne de Biscaye, perchée sur la colline.', lat: 43.2668, lng: -2.9180, category: 'monuments', emoji: '⛪', image: 'https://upload.wikimedia.org/wikipedia/commons/9/95/Bilbao_-_Basilica_de_Bego%C3%B1a_14.JPG' },
    { id: 'b20', name: 'Zorrotzaire Murals', description: 'Quartier Zorrotzaire couvert de murales géants signés par des artistes internationaux.', lat: 43.2750, lng: -2.9420, category: 'streetart', emoji: '🎨', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Zorrozaurre1.jpg' }
  ],
  routes: [
    {
      id: 'br01',
