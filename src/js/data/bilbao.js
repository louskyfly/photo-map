export const bilbao = {
  ...
  pois: [
    { id: 'b01', name: 'Guggenheim Bilbao', description: 'Musée d\'art contemporain conçu par Frank Gehry, emblème de la ville avec son architecture titane spectaculaire.', lat: 43.2677, lng: -2.9340, category: 'monuments', emoji: '🏛️', image: 'https://picsum.photos/seed/guggenheim-bilbao/400/300' },
    { id: 'b02', name: 'Cathédrale de Santiago', description: 'Cathédrale gothique du XIIIe siècle, chef-d\'œuvre architectural au cœur de la vieille ville.', lat: 43.2630, lng: -2.9276, category: 'monuments', emoji: '⛪', image: 'https://picsum.photos/seed/cathedrale-santiago-bilbao/400/300' },
    { id: 'b03', name: 'Palais d\'Arts Reina Sofía', description: 'Complexe culturel monumental de Calatrava, hébergeant opéra et spectacles.', lat: 43.2685, lng: -2.9938, category: 'architecture', emoji: '🎭', image: 'https://picsum.photos/seed/palais-arts-reina-sofia/400/300' },
    { id: 'b04', name: 'Pont Zubizuri', description: 'Pont suspendu en verre de Calatrava, joyau architectural sur la Nervion.', lat: 43.2628, lng: -2.9304, category: 'architecture', emoji: '🌉', image: 'https://picsum.photos/seed/pont-zubizuri/400/300' },
    { id: 'b05', name: 'Mirador de Artxanda', description: 'Point de vue panoramique sur toute la ville depuis la montagne.', lat: 43.2850, lng: -2.9200, category: 'viewpoints', emoji: '🔭', image: 'https://picsum.photos/seed/mirador-artxanda/400/300' },
    { id: 'b06', name: 'Parc d\'Etxebarria', description: 'Vaste parc verdoyant sur l\'ancien site industriel d\'Altos Hornos.', lat: 43.2670, lng: -2.9150, category: 'nature', emoji: '🌿', image: 'https://picsum.photos/seed/parc-etxebarria/400/300' },
    { id: 'b07', name: 'Jardins de Albia', description: 'Jardins élégants du XIXe siècle, havre de paix urbain.', lat: 43.2588, lng: -2.9320, category: 'nature', emoji: '🌺', image: 'https://picsum.photos/seed/jardins-albia/400/300' },
    { id: 'b08', name: 'Casco Viejo (Vieille Ville)', description: 'Le quartier historique Siete Calles avec ses rues médiévales et ses pintxos bars.', lat: 43.2616, lng: -2.9260, category: 'culture', emoji: '🏘️', image: 'https://picsum.photos/seed/casco-viejo-bilbao/400/300' },
    { id: 'b09', name: 'Mercado de la Ribera', description: 'Plus grand marché couvert d\'Europe, pittoresque sur les rives de la Nervion.', lat: 43.2584, lng: -2.9288, category: 'gastronomy', emoji: '🏪', image: 'https://picsum.photos/seed/mercado-ribera/400/300' },
    { id: 'b10', name: 'Azkuna Zentroa', description: 'Centre culturel réhabilité par Philippe Starck, ancien marché aux abattoirs.', lat: 43.2612, lng: -2.9392, category: 'culture', emoji: '🎪', image: 'https://picsum.photos/seed/azkuna-zentroa/400/300' },
    { id: 'b11', name: 'Funiculaire d\'Artxanda', description: 'Funiculaire offrant une ascent rapide vers le mirador panoramique.', lat: 43.2706, lng: -2.9285, category: 'unusual', emoji: '🚡', image: 'https://picsum.photos/seed/funiculaire-artxanda/400/300' },
    { id: 'b12', name: 'Street Art Ensanche', description: 'Quartier Ensanche richement décoré de fresques murales contemporaines.', lat: 43.2618, lng: -2.9330, category: 'streetart', emoji: '🎨', image: 'https://picsum.photos/seed/street-art-ensanche/400/300' },
    { id: 'b13', name: 'Église de San Nicolás', description: 'Église baroque du XVIIIe surnommée "Cathédrale des pintxos".', lat: 43.2632, lng: -2.9268, category: 'monuments', emoji: '⛪', image: 'https://picsum.photos/seed/eglise-san-nicolas/400/300' },
    { id: 'b14', name: 'Promenade de la Nervion', description: 'Promenade le long de la rivière Nervion entre le Guggenheim et la Cathédrale.', lat: 43.2620, lng: -2.9310, category: 'nature', emoji: '🌊', image: 'https://picsum.photos/seed/promenade-nervion/400/300' },
    { id: 'b15', name: 'Circuit des bars à pintxos', description: 'Circuit des meilleurs bars à pintxos du Casco Viejo.', lat: 43.2614, lng: -2.9255, category: 'gastronomy', emoji: '🍢', image: 'https://picsum.photos/seed/bars-pintxos-bilbao/400/300' },
    { id: 'b16', name: 'Teatro Arriaga', description: 'Théâtre néo-baroque inspiré de l\'Opéra Garnier, joyau architectural.', lat: 43.2598, lng: -2.9272, category: 'architecture', emoji: '🎭', image: 'https://picsum.photos/seed/teatro-arriaga/400/300' },
    { id: 'b17', name: 'Abandoibarra', description: 'Zone de régénération urbaine le long de la rivière avec sculptures contemporaines.', lat: 43.2650, lng: -2.9310, category: 'streetart', emoji: '🗿', image: 'https://picsum.photos/seed/abandoibarra/400/300' },
    { id: 'b18', name: 'Doña Casilda Park', description: 'Principal parc urbain avec étang, paons et musée des Beaux-Arts.', lat: 43.2712, lng: -2.9430, category: 'nature', emoji: '🦚', image: 'https://picsum.photos/seed/parc-dona-casilda/400/300' },
    { id: 'b19', name: 'Basílica de Begoña', description: 'Basílique gothique-Renaissance, patronne de Biscaye, perchée sur la colline.', lat: 43.2668, lng: -2.9180, category: 'monuments', emoji: '⛪', image: 'https://picsum.photos/seed/basilica-begona/400/300' },
    { id: 'b20', name: 'Zorrotzaire Murals', description: 'Quartier Zorrotzaire couvert de murales géants signés par des artistes internationaux.', lat: 43.2750, lng: -2.9420, category: 'streetart', emoji: '🎨', image: 'https://picsum.photos/seed/zorrotzaire-murals/400/300' }
  ],
  routes: [
    {
      id: 'br01',
